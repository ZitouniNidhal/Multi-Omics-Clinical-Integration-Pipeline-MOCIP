...
\lstset{
  ...
  xleftmargin=2em, framexleftmargin=1.5em, numbersep=5pt
}
\title{From Raw Sequences to FHIR Reports: A Scalable End-to-End Framework for Multi-Modal Omics Integration}
\author{
  \IEEEauthorblockN{Nidhal Zitouni\IEEEauthorrefmark{1} and Mohsen Maraoui\IEEEauthorrefmark{1}}
  \IEEEauthorblockA{
    \IEEEauthorrefmark{1}Department of Computer Science\\
    Faculty of Sciences of Monastir\\
    Monastir, Tunisia\\
    e-mail: {\tt zitouninidhal@fsm.u-monastir.tn, mohsen.maraoui@fsm.rnu.tn}
  }
}
\begin{document}
\maketitle
